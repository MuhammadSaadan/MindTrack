...
if(isset($_POST['submit'])) {
    ...
    if(empty($selectedDate)) {
        ...
        $counsellor = "Dr. Aishah Rahman"; // Replace with the actual counsellor
...
<div class="flex justify-center items-center min-h-screen bg-gray-100">
    <div class="panel sm:w-[480px] m-6 max-w-lg w-full bg-white rounded-lg p-6 shadow-md">
        ...
        <p class="lead my-2 text-center text-lg text-gray-600 dark:text-gray-400">Dr. Aishah Rahman</p>
