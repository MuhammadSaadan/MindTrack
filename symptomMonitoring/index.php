...
<div x-data="logsymptoms">
    ...
    <div x-data="charts">
        <div
            ...
            <p class="lead">
                <button type="button" x-on:click="window.location.href='/reportSymptom/symptomsReport.php'"
                    class="btn btn-dark">View Symptoms Report</button>
            </p>
        </div>
        ...
        <div class="panel">
            ...
            <form method="post" action="/symptomMonitoring/index.php" id="logSymptomForm">
                ...
                <label for="ctnSelect1"
                    class="block text-sm font-semibold text-gray-600 dark:text-gray-400 mt-1 mb-2">Symptoms:</label>
                ...
                <label for="rating"
                    class="block text-sm font-semibold text-gray-600 dark:text-gray-400 mt-4 mb-2">Symptom Intensity
                    Level:</label>
