...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            header("Location: /appointmentCounsellor/view.php?updateSuccess=true");
            exit;
        } else {
...
<ol class="flex text-primary font-semibold dark:text-white-dark">
    ...
    <li class="bg-[#ebedf2] rounded-tl-md rounded-bl-md dark:bg-[#1b2e4b]"><a href="/appointmentCounsellor/view.php"
...
<div class="panel">
    <form method="post" action="../appointmentCounsellor/edit.php" class="form">
