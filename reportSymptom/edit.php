...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: /reportSymptom/symptomsReport.php?updateSuccess=true");
            exit;
...
<div class="panel">
    ...
    <form method="post" action="/reportSymptom/edit.php">
        ...
        <select name="symptom" id="ctnSelect1" class="form-select text-white-dark" required>
            <option value="Headache" <?= ($existing_symptom == 'Headache') ? 'selected' : '' ?>>Headache</option>
            <option value="Fatigue" <?= ($existing_symptom == 'Fatigue') ? 'selected' : '' ?>>Fatigue</option>
            <option value="Nausea" <?= ($existing_symptom == 'Nausea') ? 'selected' : '' ?>>Nausea</option>
            <option value="Anxiety" <?= ($existing_symptom == 'Anxiety') ? 'selected' : '' ?>>Anxiety</option>
            <option value="Insomnia" <?= ($existing_symptom == 'Insomnia') ? 'selected' : '' ?>>Insomnia</option>
        </select>
        ...
        <label for="rating" class="block text-sm font-semibold text-gray-600 dark:text-gray-400 mt-1 mb-2">Symptom
