...
<div x-data="charts">
    <div
        ...
        <p class="lead my-5 text-center text-lg text-gray-600 dark:text-gray-400">Welcome To Admin Dashboard</p>
            ...
            <div class="pt-5 flex-1 text-sm">
                <template x-if="tab === 'home'">
                    <div>
                        ...
                        <p class="mb-4">
                            This application is designed for everyone, regardless of age, background, or location. It's
                            a
                            tool that empowers you to track your daily moods, monitor mental health symptoms, and even
                            assess your mental health using reliable tests. With easy-to-understand visualizations, you
                            can
                ...
                <template x-if="tab === 'aim'">
                    <div>
                        ...
                        <p class="mb-4">Mind Track aims to revolutionize mental health management by creating a
                            user-friendly web application that goes beyond traditional approaches. The goal is to break
                            down
                ...
                <template x-if="tab === 'objective'">
                    <div>
                        ...
                        <p> Indirectly contribute to reducing the economic burden of mental health disorders by offering
                            a
                        ...
                        <p>
                            Foster an environment that encourages openness about mental health concerns, reducing the
                            stigma
    ...
    <div x-data="carousel">
        <ul
            ...
            <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                ...
                <div
                    ...
                    <div class="p-5">
                        <h4 class="mb-3 text-info text-lg font-semibold">Manage Users</h4>
                        <p class="mb-3 text-white-dark"> Manage User's Account</p>
                        <p><button type="button" onclick="window.location.href='/dashboardAdmin/manageUsers.php'"
            ...
            <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                ...
                <div
                    ...
                    <div class="p-5">
                        <h4 class="mb-3 text-primary text-lg font-semibold">Manage Appointments</h4>
                        <p class="mb-3 text-white-dark">Manage User's and Counsellor's Appointments</p>
                        <p><button type="button" onclick="window.location.href='/appointmentAdmin/view.php'"
        ...
        <div
            ...
            <div class="p-5">
                <h4 class="mb-3 text-success text-lg font-semibold">Manage Counsellors</h4>
                <p class="mb-3 text-white-dark">Register and Manage Counsellors
                <p><button type="button" onclick="window.location.href='/counsellorAdmin/index.php'"
