            ...
            <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 text-white-dark"> Stay in tune with your emotions each day by tracking how you
                            feel.
                            It's
            ...
            <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 text-white-dark">Evaluate your depression severity level accurately through our
                            PH9
            ...
            <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 text-white-dark">Initiate meaningful progress by scheduling a consultation with
                            our
            ...
            <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 text-white-dark">Assess your mental health statusby looking at a visual summary
                            of
