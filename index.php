...
<div>
    ...
    <div class="pt-5">
        <h2 class="text-center my-5 text-2xl md:text-5xl font-bold">WELCOME TO MINDTRACK</h2>

        <p class="text-base mb-14 text-center font-semibold">Search instant answers & questions asked by popular users
        </p>
        <h3 class="font-bold text-xl md:text-3xl mb-5">Features</h3>
    ...
    <div class="space-y-5 mb-10" x-data="{ active: null }">
        <div class="border border-[#ebedf2] dark:border-[#191e3a] rounded-md bg-white dark:bg-[#0e1726] ">
            <div class="flex font-semibold p-5 cursor-pointer" :class="{'text-primary' : active === 1}"
                ...
                <span class="text-primary">What is Mindtrack?</span>
