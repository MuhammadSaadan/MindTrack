...
<?php
include 'landingPage/header-main.php';
?>
    ...
    <div x-data="charts">
        ...
        <div
            ...
            <h2 class="text-dark mb-5 mt-4 text-center text-5xl dark:text-white-light">Welcome To Mindtrack
            </h2>
                    ...
                    <ul class="flex flex-wrap justify-between mt-3 space-x-2 rtl:space-x-reverse">
                        ...
                        <li class="flex-auto text-center">
                            <a href="javascript:"
                                ...
                                @click="tab = 'objective'">Objective</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="pt-5 flex-1 text-sm">
                    <template x-if="tab === 'home'">
                        <div>
                            ...
                            <p class="mb-4">
                                ...
                                well-being. In a world where mental health issues are on the rise, Mind Track serves as
                                your
                                personalized companion, offering a user-friendly platform to monitor, understand, and
                                manage
                                your mental health.
                            </p>
                            <p class="mb-4">
                                This application is designed for everyone, regardless of age, background, or location.
                                It's
                                a
                                tool that empowers you to track your daily moods, monitor mental health symptoms, and
                                even
                                assess your mental health using reliable tests. With easy-to-understand visualizations,
                                you
                                can
                            ...
                            <p class="mb-4">
                                ...
                                In essence, Mind Track is not just an application; it's a companion on your mental
                                health
                                journey.
                                It aims to reduce the stigma associated with seeking help, encourage open conversations,
                                and
                                contribute to an overall improvement in mental health outcomes. With Mind Track, you
                                have a
                                comprehensive and user-friendly tool to navigate the complexities of mental well-being,
                                ensuring
                    ...
                    <template x-if="tab === 'aim'">
                        <div>
                            ...
                            <p class="mb-4">Mind Track aims to revolutionize mental health management by creating a
                                user-friendly web application that goes beyond traditional approaches. The goal is to
                                break
                                down
                                barriers to mental health support, offering a cost-effective and convenient solution
                                that
                    ...
                    <template x-if="tab === 'objective'">
                        <div>
                            ...
                            <p>
                                Provide a platform that can be easily accessed by individuals of all ages, backgrounds,
                                and
                            ...
                            <p>
                                Create tools that allow users to personalize their mental health management journey,
                                identifying
                            ...
                            <p> Indirectly contribute to reducing the economic burden of mental health disorders by
                                offering
                                a
                            ...
                            <p>
                                Foster an environment that encourages openness about mental health concerns, reducing
                                the
                                stigma
                            ...
                            <p>
                                Provide a rich resource of mental health information to educate users about various
                                mental
                ...
                <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 text-white-dark"> Stay in tune with your emotions each day by tracking how
                                you
                                feel.
                                It's
                ...
                <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 text-white-dark">Take a daily check on how you're feeling physically and
                                emotionally.
                ...
                <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 text-white-dark">Evaluate your depression severity level accurately through
                                our
                                PH9
                                Questionnaire, a sophisticated tool designed to provide a nuanced analysis of your
                                emotional
                                state.
                            </p>
                ...
                <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 text-white-dark">Initiate meaningful progress by scheduling a consultation
                                with
                                our
                                seasoned counselors. Benefit from their expertise as you navigate your path toward
                                emotional
                ...
                <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 text-white-dark">Assess your mental health statusby looking at a visual
                                summary
                                of
